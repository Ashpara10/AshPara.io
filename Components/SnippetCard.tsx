...
const SnippetCard = ({ snippet }: { snippet: Snippet }) => {
  return (
    <article className=" w-full bg-white hover:bg-gray-100 dark:bg-dark flex flex-col items-center justify-center gap-y-1 border  border-gray-300 dark:border-bdark dark:hover:bg-[#1a1a1a] rounded-md px-6 py-4 ">
